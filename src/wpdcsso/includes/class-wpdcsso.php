...
<div class="wrap">
	...
	<input type="hidden" name="page_options" value="wpdcsso_dc_url,wpdcsso_email_username,wpdcsso_shared_secret,wpdcsso_shared_token,wpdcsso_single_sign_out" />
    ...
    function my_profile_update($user_id)
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://api.digitalchalksandbox.com/dc/api/v5/users?email=" . $user_email,
    ...
    function save_userfiled($user_id, $sscid)
    {
        ...
        if ($token) {
            ...
            curl_setopt_array($curl2, array(
                CURLOPT_URL => "https://api.digitalchalksandbox.com/dc/api/v5/userfields",
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_CUSTOMREQUEST => "GET",
                CURLOPT_HTTPHEADER => array(
                    "Authorization: Bearer " . $token,
            ...
            curl_setopt_array($curl3, array(
                CURLOPT_URL => "https://api.digitalchalksandbox.com/dc/api/v5/users/" . $cssoid . "/userfieldvalues",
                CURLOPT_RETURNTRANSFER => true,
